...
/**
 * REST controller for managing {@link ir.bamdad.shop.domain.Student}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class StudentResource {
    ...
    public ResponseEntity<Student> createStudent(@Valid @RequestBody Student student) throws URISyntaxException {
       ...
       if(student.getId() != null && getStudent(student.getId()) != null){
           return updateStudent(student.getId(),student);
        }
        if(student.getId()!= null && findByMobileNumber(student.getMobileNumber())!=null){
            return updateStudent(student.getId(),student);
        }
    ...
    private Student findByMobileNumber(String mobileNumber){
